...
public class GWTServiceTestGotoRelatedProvider extends AbstractGWTServiceGotoRelatedProvider
{
    ...
    protected List<? extends GotoRelatedItem> getGotoRelatedItems(Collection<? extends PsiElement> elements)
    {
        ...
        return GotoRelatedItem.createItems(collect, "Google Web Toolkit (Test)");
    }
}